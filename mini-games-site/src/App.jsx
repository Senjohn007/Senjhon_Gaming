...
/* Other animated background layer
// Use one of:
//import AnimatedBackground from "./components/AnimatedBackground.jsx";
import AnimatedBackground from "./components/WaveBackground.jsx";
import AnimatedBackground from "./components/MatrixBackground.jsx";
...
function AppShell() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent text-slate-100 relative">
      ...
      {/* header */}
      <header className="relative z-20 border-b border-purple-900/30 bg-gradient-to-r from-slate-950 via-purple-950/90 to-slate-950 backdrop-blur-md shadow-2xl shadow-purple-900/20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-4 md:py-5">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="relative">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg flex items-center justify-center transform rotate-12 shadow-lg shadow-purple-600/40">
          ...
          {/* Navigation menu */}
          <nav className={`mt-4 transition-all duration-300 overflow-hidden ${mobileMenuOpen ? 'max-h-96' : 'max-h-0 md:max-h-96'}`}>
      ...
      <footer className="relative border-t border-purple-900/30 bg-gradient-to-r from-slate-950 via-purple-950/50 to-slate-950">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="border-t border-slate-800/50 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 rounded-full bg-slate-800/60 flex items-center justify-center text-slate-400 hover:bg-purple-800/60 hover:text-purple-300 transition-all">
...
export default function App() {
  // Wrap AppShell with SettingsProvider
  return (
    <SettingsProvider>
      <AppShell />
    </SettingsProvider>
